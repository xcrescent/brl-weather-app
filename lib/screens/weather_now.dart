  ...
  takeSS() async {
    ...
    if (imageData != null)
      await Navigator.of(context).push(MaterialPageRoute(
        builder: (BuildContext context) => ShareWidget(imageData: imageData),
      ));
  }
                    ...
                    if (value == 1) {
                      ...
                      takeSS();
                        ...
                        ScaffoldMessenger.of(context)
                            .showSnackBar(const SnackBar(content: Text("Go to the homescreen to share weather"),backgroundColor: Color(0xff82BAFB),));
                      }
                    }
                  },
                  iconSize: 28,
